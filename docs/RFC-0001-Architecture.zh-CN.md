...
- **相关 RFC**：[RFC-0002](RFC-0002-ANA-Chain.zh-CN.md)、[RFC-0003](RFC-0003-Envelope.zh-CN.md)、[RFC-0004](RFC-0004-Memory-System.zh-CN.md)、[RFC-0005](RFC-0005-Agent-Runtime.zh-CN.md)
...
2. **模型与记忆分离**：模型权重、上下文缓存和用户长期记忆不是同一对象，不得被强绑定。
